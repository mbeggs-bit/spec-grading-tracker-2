...
export const COURSES = {
  ...
  "ECEL 4850": {
    ...
    tracks: {
      ...
      C: { req: ["pwa-chart"], pick: [{ from: ["les1","les2"], need: 1, label: "lesson plan" }, { from: ["ct1","ct2"], need: 1, label: "reflection" }, { from: ["pwa-a1","pwa-a2","pwa-a3"], need: 1, label: "analysis" }, { from: ["fp-w1","fp-w2","fp-w3"], need: 1, label: "warm up" }] },
      D: { req: [], pick: [{ from: ["les1","les2"], need: 1, label: "lesson plan" }, { from: ["ct1","ct2"], need: 1, label: "reflection" }, { from: ["fp-w1","fp-w2","fp-w3"], need: 1, label: "warm up" }] },
    },
  },
  "ECEL 3468": {
